...
export default defineComponent({
    name: 'CrmClientContextSmsSkeleton',
    props: {
        /**骨架屏**/
    ...
    setup(props, { slots }) {
        return () => (
            <common-element-scrollbar class="crm-client-context-sms-skeleton">
                <common-skeleton-provider
                    is-white
                    class-name="flex flex-col flex-1 overflow-hidden"
